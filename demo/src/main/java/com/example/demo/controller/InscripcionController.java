...
public class InscripcionController {
        ...
        public String inscribirseAOferta(@PathVariable Long ofertaId,
                ...
                try {
                        ...
                        System.out.println(
                                        "💰 Iniciando proceso de pago e inscripción para oferta: " + ofertaId
                                                        + " (Rol: " + rol + ")");
                        ...
                        if ("DOCENTE".equals(rol)) {
                                ...
                                if (oferta instanceof Curso) {
                                        ...
                                        yaEsDocenteAqui = formacion.getDocentes() != null && formacion.getDocentes()
                                                        .stream()
                                                        .anyMatch(d -> d.getId().equals(docente.getId()));
                                }
                                ...
                                System.out.println(
                                                "✅ El docente NO enseña en esta oferta, puede inscribirse como alumno");
                        }
                        ...
                        */
                        ...
                        // ========================================
                        System.out
                                        .println("💵 Oferta con costo: $" + oferta.getCostoInscripcion()
